...
@Table(name = "TB_ESTADO",  uniqueConstraints = {
        ...
        @UniqueConstraint(name = "UK_SGL_ESTADO", columnNames = {"SGL_ESTADO"})
})
public class Estado {
    @Id
    ...
    @Column(name = "NM_ESTADO", nullable = false, unique = true)
    private String nome;

    @Column(name = "SGL_ESTADO", nullable = false, unique = true)
